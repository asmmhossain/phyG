...
_magic_number = 6
_modified_time = 1382433163.084682
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0xaaa93e8cL', context._clean_inheritance_tokens(), templateuri=u'/display_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0xaaa93e8cL')] = ns

    # SOURCE LINE 4
    ns = runtime.TemplateNamespace('__anon_0xaaa93f4cL', context._clean_inheritance_tokens(), templateuri=u'/tagging_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0xaaa93f4cL')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0xaaa93e8cL')._populate(_import_ns, [u'*'])
        _mako_get_namespace(context, '__anon_0xaaa93f4cL')._populate(_import_ns, [u'render_individual_tagging_element', u'render_community_tagging_element'])
