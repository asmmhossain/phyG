...
_magic_number = 6
_modified_time = 1381349574.827566
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0xd537d4c', context._clean_inheritance_tokens(), templateuri=u'/base_panels.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0xd537d4c')] = ns

    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0xd537cec', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0xd537cec')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0xd537d4c')._populate(_import_ns, [u'overlay'])
        _mako_get_namespace(context, '__anon_0xd537cec')._populate(_import_ns, [u'render_msg'])
