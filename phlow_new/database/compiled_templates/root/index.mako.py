...
_magic_number = 6
_modified_time = 1392805205.64682
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x29ad2d50', context._clean_inheritance_tokens(), templateuri=u'/root/tool_menu.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x29ad2d50')] = ns

    # SOURCE LINE 4
    ns = runtime.TemplateNamespace('__anon_0x29ad2990', context._clean_inheritance_tokens(), templateuri=u'/history/history_panel.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x29ad2990')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x29ad2d50')._populate(_import_ns, [u'*'])
        _mako_get_namespace(context, '__anon_0x29ad2990')._populate(_import_ns, [u'current_history_panel'])
