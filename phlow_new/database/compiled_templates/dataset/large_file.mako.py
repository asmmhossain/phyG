...
_magic_number = 6
_modified_time = 1392818457.839251
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7f16a4655f10', context._clean_inheritance_tokens(), templateuri=u'/dataset/display.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f16a4655f10')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f16a4655f10')._populate(_import_ns, [u'render_deleted_data_message'])
