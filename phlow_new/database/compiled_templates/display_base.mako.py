...
_magic_number = 6
_modified_time = 1392818457.892258
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 12
    ns = runtime.TemplateNamespace('__anon_0x7f16a827e990', context._clean_inheritance_tokens(), templateuri=u'/tagging_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f16a827e990')] = ns

    # SOURCE LINE 13
    ns = runtime.TemplateNamespace('__anon_0x7f16a827e2d0', context._clean_inheritance_tokens(), templateuri=u'/display_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f16a827e2d0')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f16a827e990')._populate(_import_ns, [u'render_individual_tagging_element', u'render_community_tagging_element'])
        _mako_get_namespace(context, '__anon_0x7f16a827e2d0')._populate(_import_ns, [u'*'])
